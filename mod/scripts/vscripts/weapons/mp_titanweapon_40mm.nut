...
void function ApplyTrackerMark( entity owner, entity hitEnt )
{
	...
	//SetTeam( trackerRockets, TEAM_BOTH )
	...
	//print( "old tracker count: " + string( oldCount ) )
	//print( "tracker count: " + string( count ) )
...
void function Tracker40mm_DamagedTarget( entity ent, var damageInfo )
{
	...
	if( friendlyFireOn && ent.GetTeam() == attacker.GetTeam() && ent.GetArmorType() == ARMOR_TYPE_HEAVY )
	{
